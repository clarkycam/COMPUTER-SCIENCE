...
def solve_f2l(cube):
    ...
    # ===== EXTRACT ORANGE-GREEN SLOT PIECES TO TOP =====
    print("\n=== EXTRACTING ORANGE-GREEN SLOT PIECES ===")
    ...
    if is_pair_solved(cube, og_corner, og_edge, "orange-green"):
        ...
        moves.extend(og_extraction_moves)
        ...
        if corner_ok_og and edge_ok_og:
            ...
            print(f"✗ WARNING: Orange-green extraction failed - Corner in top: {corner_ok_og}, Edge in top: {edge_ok_og}")
