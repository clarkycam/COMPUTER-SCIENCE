...
# --- Content frame for cube and colour picker ---
cube_area = customtkinter.CTkFrame(cube_frame, fg_color="transparent")
cube_area.pack(pady=20)

# --- Cube grid frame (main cube display) ---
cube_grid = customtkinter.CTkFrame(cube_area, width=800, height=500, fg_color="transparent")
cube_grid.pack(side="left", padx=(20, 20))  # cube centered visually

# --- Colour picker frame (to the left of cube grid) ---
colour_picker_frame = customtkinter.CTkFrame(cube_area, corner_radius=10, width=240, height=500)
colour_picker_frame.pack(side="left", padx=(0, 20))
